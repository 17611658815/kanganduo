...
Page({
  ...
  onLoad: function (options) {
    ...
    var tiemer = setInterval(function () {
      console.log(that.data.docInfo2)
      that.data.docInfo2 = that.data.docInfo2 ? that.data.docInfo2 : app.docInfo;
      var adept = that.data.docInfo2.adeptInfo.join(',')
      console.log(adept)
      var signImg = wx.getStorageSync('protocol');
       var docInfo2 = wx.getStorageSync('docInfo');
       console.log(that.data.docInfo.xyImg);
      that.setData({
        "docInfo.xyImg": signImg,
        adept: adept,
        name: that.data.docInfo2.userInfo
      })
  ...
  goreview(){
    wx.setStorageSync("phone", this.data.docInfo2.phoneInfo);
    wx.setStorageSync("userinfo", this.data.docInfo2.phoneInfo);
    wx.reLaunch({
    ...
    if (that.data.docInfo.userPic == '') {
      ...
      wx.request({
        ...
        data: {
          appid:app.globalData.appid,
          name:that.data.docInfo2.userInfo,
          mobile:that.data.docInfo2.phoneInfo,
          hospital:that.data.docInfo2.hospitalInfo,
          adept: that.data.adept,
          identity_code: that.data.docInfo2.idcard,
          ...
          department: that.data.docInfo2.deskInfo, //科室
          self_video: that.data.docInfo.self_video,//视频
          organization:1,
