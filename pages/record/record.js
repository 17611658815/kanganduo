...
Page({
  ...
  onLoad: function (option) {
    ...
    //录音管理，new 出 第二阶段的实例
    if (is_self != 1) {
      var url = 'https://mfkapi.39yst.com/appInterface/kangaiduo/getQuestionInfo/'
      that.getQuestion(question, url)
    } else {
      var url = 'https://mfkapi.39yst.com/appInterface/kangaiduo/getSelfQuestionInfo/'
      that.getQuestion(question, url)
    }
  ...
  nextMsg() {
    ...
    if (that.data.recording) {
      ...
      wx.request({
        ...
        url: 'https://mfkapi.39yst.com/appInterface/kangaiduo/getNextQuestion/',
        data: {
          appid: app.globalData.appid,
          userid: that.data.userid,
          questionid: that.data.question
  ...
  upLoad: function () {
    ...
    var url = that.data.is_self != undefined ? 'https://mfkapi.39yst.com/appInterface/kangaiduo/saveSelfRecordAnswer/' : 'https://mfkapi.39yst.com/appInterface/kangaiduo/saveRecordAnswer/'
    wx.showLoading({
      title: '上传中...',
      mask: true,
      success: function (res) { },
  ...
  getreacr() {
    ...
    that.data.timOut = setTimeout(function () {
      wx.request({
        url: 'https://mfkapi.39yst.com/appInterface/kangaiduo/getRecordInfo/',
  ...
  subAudioTxt() {
    ...
    wx.request({
      url: 'https://mfkapi.39yst.com/appInterface/kangaiduo/saveExpertAnswer/',
      header: {
        'content-type': 'application/json'
      },
      data: {
