...
Page({
  ...
  onLoad: function (option) {
    ...
    var url = 'https://mfkapi.39yst.com/appInterface/kangaiduo/getExpertRecordList/?userid=' + that.data.userid + '&page=' + that.data.page + '&appid=' + app.globalData.appid;
    that.loadList(url);
    // 获取硬件信息
    wx.getSystemInfo({
  ...
  pullUpLoad() {
    ...
    if (that.data.currentTab == 0) {
      ...
      var url = 'https://mfkapi.39yst.com/appInterface/kangaiduo/getExpertRecordList/?userid=' + that.data.userid + '&page=' + that.data.page + '&status=0' + '&appid=' + app.globalData.appid;;
      that.loadList(url);
    } else if (that.data.currentTab == 2) {
      console.log('未通过')
      var url = 'https://mfkapi.39yst.com/appInterface/kangaiduo/getExpertRecordList/?userid=' + that.data.userid + '&page=' + that.data.page + '&status=2' + '&appid=' + app.globalData.appid;;
      that.loadList(url);
    } else {
      var url = 'https://mfkapi.39yst.com/appInterface/kangaiduo/getExpertRecordList/?userid=' + that.data.userid + '&page=' + that.data.page + '&status=1' + '&appid=' + app.globalData.appid;;
      that.loadList(url);
    }
  },
  // 滑动切换tab
