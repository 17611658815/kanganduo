...
Page({
  ...
  searchMsgs: function (e) {
    ...
    if (e.detail.value.length > 0) {
      wx.request({
        url: 'https://mfkapi.39yst.com/appInterface/kangaiduo/getLikeQuestion/',
        data: {
  ...
  specialityIllness() {
    let that = this
    wx.request({
      url: 'https://mfkapi.39yst.com/appInterface/kangaiduo/getExpertIllness/',
      data:{
        appid:app.globalData.appid,
  ...
  searchIllness(){
    ...
    if (that.data.searchMsg!=''){
      wx.request({
        url: 'https://mfkapi.39yst.com/appInterface/kangaiduo/getIllnessQuestionList/',
        data: {
          appid: app.globalData.appid,
          userid: that.data.userid,
